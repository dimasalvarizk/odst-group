    ...
    <section id="about" className="relative min-h-[85vh] md:min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center text-white fade-in mt-16 md:mt-24">
        ...
        <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold tracking-tight mb-5 leading-tight">
          Welcome to ODST Group
        </h1>

        {/* Paragraph Description */}
        <p className="text-base md:text-xl text-white/90 max-w-2xl mx-auto mb-10 leading-relaxed font-spectral font-normal">
          Your trusted partner for Hajj & Umrah — providing world-class <br className="hidden md:inline" /> hotels, aviation, and travel services.
        </p>
      ...
      <div className="absolute bottom-10 left-6 md:left-12 z-10 flex space-x-2">
